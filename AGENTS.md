...
See `backlog.md` **Suggested Sprint Breakdown**. Sprint 0–35 are closed. Next is **Sprint 36 (AMD-11)** — change records (comment, documents, pins, `needs_review`). Decision: `docs/adr/0005-two-axis-versions.md`; design at `docs/design/two-axis-versions.md`. Do not start ED-7 until AMD-11 is Done. Pull from **Later / Ideas** only if the user asks. Do not start SRV-7 (MCP) until asked.
