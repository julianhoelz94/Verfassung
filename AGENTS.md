...
See `backlog.md` **Suggested Sprint Breakdown**. Sprint 0–13 are closed. **Sprint 14** (editor quality and confidence: IDN-10, UI-10, UI-14) is next. Pull from **Later / Ideas** only if the user asks. Do not start SRV-7 (MCP) until asked.
