...
See `backlog.md` **Suggested Sprint Breakdown**. Sprint 0–11 are closed. **Sprint 12** (public correctness and accessibility: UI-7, UI-8, UI-9, UI-16, UI-17, IDN-13) is next. Sprints 13–14 are planned. Pull from **Later / Ideas** only if the user asks. Do not start SRV-7 (MCP) until asked.
