...
### Sprint 29: Hop kinds and amendment revisions (schema) — next
Ready: **ARCH-7**, **CAT-5**, **AMD-7**.
...
### Sprint 30: Curated amendment API
Ready: **AMD-8**, **AMD-9**, **GOV-8**.
...
### Sprint 31: Editor publish and public surfaces
Ready: **ED-6**, **UI-42**, **UI-46**, **UI-49**, **UI-50**.
...
### Sprint 32: Amendment list editor
Ready: **UI-ED-2**, **UI-43**, **UI-48**.
...
### Sprint 33: Covert histories, suggest-from-diff, journeys
Ready: **AMD-10**, **UI-44**, **UI-45**, **UI-47**, **UI-51**.

Suggest change rows from two snapshots without persisting. Staff panel for amendment revisions (restore = new tip). Staff snapshot history page. Playwright: record a law vs typo-fix hop.

Owners: amendment-service (AMD-10), gateway-web. No L; several M — slip UI-51 only if time runs out.
...
Do not pull ARCH-7–UI-51 from Ideas — they are **Ready** under Sprints 29–33.
